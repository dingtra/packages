...
func (let *MakeDingStruct ) Polls ()  string {

	details := []string{}

	// ------------------------------- polls
	details = append(details,`<div class="flxjss090">`)
	details = append(details, "<div style='padding:10px 10px 10px 10px;' class='pollsxy91x89'>")
	...
	// Result["brnchoptns09x0"] = template.HTML(BranchOptions("polls"))
