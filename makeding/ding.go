...
// func (let *MakeDingStruct ) NewDing (id, user string, post []string) string {
// 	details := []string{}
...
// 	details = append(details, "<div style='display:none;' id='mkdngform90res' class='nwdngxr093-class'> <div  class='nwdngxr093-class-chld'>")

// 	// image errr0r
// 	details = append(details, "<div style='position:fixed;' id='file-err-09res2'></div>")
	
// 	// phase parent
// 	details = append(details, "<div class='nwdngxr093-other-phase-one'>")

// 	details = append(details, "<div class='nwdngxr093-welcome-greet'><div id='greetings01'><span>Add a greeting note</span></div>  </div>")

// 	// add a welcome
// 	details = append(details, "<div class='nwdngxr093-welcome'><div class='nwdngxr093-welcome-ch'>")

// 	// 
// 	details = append(details, "<div class='nwdngxr093-welcome-pase-one'>")
// 	details = append(details, "<div id='nwdngxr093-welcome-pase-two-title'><select name='greet'><option>🖐️</option><option>🥳</option> <option>🥇</option> <option>👍</option> <option>🐿️</option> <option>🎉</option> <option>⏰</option> <option>👶</option> <option>📖</option> <option>💐</option> <option>🥱</option> <option>👋</option> <option>💭</option> <option>🥱</option> <option>😜</option> <option>💩</option> <option>🚨</option></select></div>")
// 	details = append(details, "</div>")
// 	// 

// 	details = append(details, "<div class='nwdngxr093-welcome-pase-slash'><span>/</span></div>")

// 	details = append(details, "<div class='nwdngxr093-welcome-pase-two'><span><input type='text' name='greetings' placeholder='Add greeting' /></span></div>")
...
// 	// description
// 	details = append(details, "<div class='nwdngxr093-description'><span> <textarea id='frmpst27890editable' name='about' placeholder='What&#39;s the ding all about?'></textarea> </span></div>")

// 	// srch details
// 	details = append(details, "<div class='create-new-ding-class-textarea-search'><div id='tgbn08'>")
// 	details = append(details, "</div></div>")
// 	// srch details
...
// 	// 
// 	details = append(details, "<div class='nwdngxr093-options-phase'>")
// 	details = append(details, "<div id='nwdngxr093-options-phase-svg'><span><i data-feather='shopping-bag' color='black'></i></span></div>")
// 	details = append(details, "<div id='nwdngxr093-options-phase-title'><span>Sell items</span></div>")
// 	details = append(details, "</div>")
// 	//

// 	// 
// 	details = append(details, "<div style='border-left:1px solid #ccc;padding-left:5px;' class='nwdngxr093-options-phase'>")
// 	details = append(details, "<div id='nwdngxr093-options-phase-svg'><span><i data-feather='trending-up' color='black'></i></span></div>")
// 	details = append(details, "<div id='nwdngxr093-options-phase-title'><span>Business</span></div>")
// 	details = append(details, "</div>")
// 	//
...
// 	details = append(details, ConnectBranch(id))

// 	details = append(details, "</div>")
// 	// phase parent

// 	// phase parent two
// 	details = append(details, "<div style='position:relative;' class='nwdngxr093-other-phase-two'>")

// 	details = append(details, "<div id='nwdngxr093-other-phase-two-block' class='nwdngxr093-other-phase-two-block'><div class='nwdngxr093-other-phase-two-block-ch'>")

// 	// files
// 	details = append(details, "<div class='create-new-ding-class-files'><div class='create-new-ding-class-files-ch'>")
// 	details = append(details, "<div id='fl091282'><label for='filer092'><div id='create-new-ding-class-files01'><i data-feather='image'></i> <span> Add files here</span></div></label></div>")
// 	details = append(details, "<div style='display:none;' id='fl091281'><div style='display:flex;overflow: auto;white-space: nowrap;' id='fl091281ch'></div></div>")
// 	// video
// 	details = append(details, "<div style='display:none;' id='fl091280'><video id='vdfl091280' controls >not supported</video></div>")
...
// 	// submit
// 	details = append(details, "<div style='display:none;' id='frmpst27890submtbtn'><div class='frmpst27890submtbtn-block'><div style='position:absolute;bottom:0;left:5;right:0;'><div style='pointer-events:none;' class='frmpst27890submt'><div id='frmpst27890submt'><span>New ding</span></div></div> </div></div></div>")

// 	details = append(details, "</div>")
// 	// phase parent two

// 	details = append(details, "</div></div></form>")
// 	// parent
